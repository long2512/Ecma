                  ...
                  <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                      ${data.map((post) => {
                          ...
                          <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">${post.newprice}</div>
                          </td>
                          <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">${post.oldprice}</div>
                          </td>
                          <td class="px-6 py-4 whitespace-nowrap">
                            <a href="/editProducts/${post.id}"><div class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-lime-700 hover:bg-yellow-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
